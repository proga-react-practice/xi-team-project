...
export interface Props {
  ...
  editCard?: Card | null; // Allow null value for editCard
  onCancel: () => void; // Add onCancel function
}
...
const Form: React.FC<Props> = ({ onSubmit, editCard, onCancel }) => {
  ...
  // Populate default values if editCard prop is provided
  useEffect(() => {
    if (editCard) {
      reset(editCard);
    }
    ...
    <>
      ...
      >
        ...
        <TextField
          ...
          variant="outlined"
          value={form.watch("name")} // Bind value to form state
          {...register("name", {
        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            value={form.watch("difficulty")} // Bind value to form state
            {...register("difficulty", {
        ...
        >
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              value={form.watch("currency")} // Bind value to form state
              {...register("currency", {
